...
5. 通过[skywalking](https://skywalking.apache.org/)实现分布式链路的性能监控
6. 集成[eclipse collection](https://github.com/eclipse-collections/eclipse-collections),实现数据的高效运算，需要监控内存使用情况